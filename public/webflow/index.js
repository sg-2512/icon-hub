...
(() => {
  ...
  var require_scheduler_production = __commonJS({
    "node_modules/scheduler/cjs/scheduler.production.js"(exports) {
      ...
      exports.unstable_forceFrameRate = function(fps) {
        0 > fps || 125 < fps ? void 0 : frameInterval = 0 < fps ? Math.floor(1e3 / fps) : 5;
      };
  ...
  // src/svg.ts
  var ALLOWED_HOSTNAMES = /* @__PURE__ */ new Set([
    "iconsearch.info",
    "www.iconsearch.info",
    "cdn.iconsearch.info"
  ]);
  var PAINT_ATTRIBUTES = ["fill", "stroke"];
  ...
  function normalizeHttpsUrl(value) {
    ...
    const candidate = trimmed.startsWith("//") ? `https:${trimmed}` : trimmed.startsWith("/") ? `https://iconsearch.info${trimmed}` : trimmed;
    try {
  ...
  function sanitizeSvg(markup) {
    const cleanSvg = purify.sanitize(markup.trim(), {
  ...
  function styleSvg(markup, options) {
  ...
  async function resolveWebflowUserToken() {
    try {
      if (typeof webflow !== "undefined" && typeof webflow.getIdToken === "function") {
  ...
  function subscribeToSelection(callback) {
    if (typeof webflow === "undefined") {
      callback({
        hasSelection: true,
        canInsert: true,
    ...
    try {
      if (typeof webflow.subscribe === "function") {
  ...
  async function insertIconToCanvas(options) {
    if (typeof webflow === "undefined") {
    ...
    try {
      if (typeof webflow.createAsset === "function") {
        createdAsset = await webflow.createAsset(dataUrl, filename);
      }
    } catch {
    }
    const imagePreset = webflow.elementPresets.Image;
    let newElement = null;
    if (typeof selectedElement.append === "function") {
      newElement = await selectedElement.append(imagePreset);
    } else if (typeof selectedElement.prepend === "function") {
      newElement = await selectedElement.prepend(imagePreset);
    }
    if (newElement) {
  ...
  function App() {
    ...
    const [legalOnly, setLegalOnly] = (0, import_react.useState)(true);
    const [size, setSize] = (0, import_react.useState)(64);
    const [color, setColor] = (0, import_react.useState)("#111827");
    const [view, setView] = (0, import_react.useState)("browse");
    const [icons, setIcons] = (0, import_react.useState)([]);
    const [recentIcons, setRecentIcons] = (0, import_react.useState)([]);
    ...
    const [inserting, setInserting] = (0, import_react.useState)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "app-container", children: [
      ...
      !token ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "auth-card", style: { padding: "24px 16px", textAlign: "center", background: "var(--surface)", borderRadius: 10, border: "1px solid var(--line)", margin: "20px 0" }, children: [
        ...
        !userCode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          isAllowedAuthUrl(verificationUri) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "a",
            {
